...
---@alias IterDiffSide 'left'|'right'

---@class IterDiffHunkPosition
...
---@param raw_lines string[]?
---@return IterDiffLine[]
---@return table<integer, IterDiffLine>
...
---@param by_raw_row table<integer, IterDiffLine>
---@param hunk IterDiffHunk
---@param raw_row integer
---@return integer?
