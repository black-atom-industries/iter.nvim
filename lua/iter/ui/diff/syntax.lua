---@class IterSyntaxSpan
---@field group string
---@field start_col integer
---@field end_col integer

---@class IterDiffSyntaxSource
...
---@param lines string[]
---@return table<integer, IterSyntaxSpan[]>
...
---@param spans table<integer, IterSyntaxSpan[]>
---@return boolean
...
---@param source IterDiffSyntaxSource?
---@param parsed IterDiffLine[]
---@return table<string, table<integer, IterSyntaxSpan[]>>?
