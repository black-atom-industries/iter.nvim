...
local source_syntax = require('iter.ui.diff.syntax')
local render = require('iter.ui.render')

---@class IterDiffRenderOpts
---@field show_headers boolean?
---@field show_numbers boolean?
---@field syntax IterDiffSyntaxSource?
...
---@param line IterDiffLine
---@param width integer
---@param opts IterDiffRenderOpts
---@return string
...
---@param line IterRenderLine
---@param spans IterSyntaxSpan[]?
...
---@param line IterRenderLine
---@param diff_line IterDiffLine
---@param source_spans table<string, table<integer, IterSyntaxSpan[]>>?
---@param width integer
---@param opts IterDiffRenderOpts
